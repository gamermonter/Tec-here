...
import face_recognition # Face Recognition para reconhecimento facial
import mysql.connector # MySQL para conexão com o banco de dados
import numpy as np # NumPy para manipulação de matrizes do OpenCV
from flask import Flask, render_template, Response # Flask para gerenciar a aplicação web
